    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12">
          {products.map((product, index) => (
            <motion.div
              ...
              className="bg-white rounded-3xl p-6 md:p-8 shadow-sm border border-gray-100 hover:shadow-lg transition-shadow relative overflow-hidden"
            >
              ...
              <div className="mb-4 bg-orange-50 w-20 h-20 rounded-2xl flex items-center justify-center relative z-10">
                {product.icon}
              </div>
        ...
        <motion.div
          ...
          className="bg-gradient-to-r from-krishna-blue to-krishna-blue-light rounded-3xl p-8 md:p-10 text-center text-white shadow-xl relative overflow-hidden"
        >
